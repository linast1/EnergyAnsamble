...
# Pašalinami nebereikalingi stulpeliai
...
print(f'LGBM Mokymo AUC: {train_auc:.4f}')
print(f'LGBM Testavimo AUC: {val_auc:.4f}')
...
plt.title('LightGBM požymių svarba (Top 15)')
plt.xlabel('Svarba')
plt.ylabel('Požymis')
plt.tight_layout()
plt.savefig('lgbm_požymių_svarba.png')
print("\nPožymių svarbos grafikas išsaugotas kaip 'lgbm_požymių_svarba.png'")